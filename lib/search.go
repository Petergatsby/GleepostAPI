...
func (api *API) UserSearchUsersInNetwork(user gp.UserID, first, last string, netID gp.NetworkID) (users gp.UserList, err error) {
...
func (api *API) UserSearchGroups(userID gp.UserID, name string) (groups gp.GroupList, err error) {
