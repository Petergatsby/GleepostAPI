...
//Up20141120163306 is executed when this migration is applied
func Up20141120163306(txn *sql.Tx) {
...
//Down20141120163306 is executed when this migration is rolled back
func Down20141120163306(txn *sql.Tx) {
