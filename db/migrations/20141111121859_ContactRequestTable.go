...
//Up20141111121859 is executed when this migration is applied
func Up20141111121859(txn *sql.Tx) {
...
//Down20141111121859 is executed when this migration is rolled back
func Down20141111121859(txn *sql.Tx) {
